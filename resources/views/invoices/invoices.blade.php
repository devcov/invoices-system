            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                        ...
                        <a href="invoices/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                ...
                                <a class="modal-effect btn btn-sm btn-dark " href="{{ url('export_invoices') }}"
                                ...
                                @foreach ($invoices as $item)
                                    ...
                                    <tr>
                                        ...
                                        @if ($item->Value_Status == 1)
                                            <td><span class="badge badge-pill badge-success">{{ $item->Status }}</span>
                                            </td>
                                        @elseif($item->Value_Status == 2)
                                            <td><span class="badge badge-pill badge-danger">{{ $item->Status }}</span>
                                            </td>
                                        @else
                                            <td><span class="badge badge-pill badge-warning">{{ $item->Status }}</span>
                                            </td>
                                        @endif
