                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            ...
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="notifications_count">{{'عدد الاشعارات الغير مقروءة'.':'. (auth()->user()->unreadNotifications->count()) }}</p>
                        </div>
                        ...
                        <div class="main-notification-list Notification-scroll">
                            <a class="d-flex p-3 border-bottom" href="{{ url('InvoicesDetails') }}/{{ $notification->data['id'] }}">
                                ...
                                <div class="mr-3">
                                    ...
                                    <div class="notification-subtext">{{$notification->created_at}} ago</div>
                                </div>
