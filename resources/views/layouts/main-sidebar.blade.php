		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="side-item side-item-category">fawatir</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">فواتير غير مدفوعة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">فواتير مدفوعة جزيا</a></li>
