                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        $sum1 = \App\Models\Invoices::sum('total');

                                        $sum2 = \App\Models\Invoices::where('Value_Status', 2)->sum('total');
                                        $per = '';
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        $sum2 = \App\Models\Invoices::where('Value_Status', 1)->sum('total');
                                        $per = '';
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    ...
                                    $sum2 = \App\Models\Invoices::where('Value_Status', 3)->sum('total');
                                    $per = '';
